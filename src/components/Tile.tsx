...
const Tile = (
    { row, col, isStart, isEnd, isWall, isTraversed, isPath, handleMouseDown, handleMouseUp, handleMouseEnter }:
        {
            row: number; col: number; isStart: boolean; isEnd: boolean; isWall: boolean; isTraversed: boolean;
            isPath: boolean, handleMouseDown: MouseFunction, handleMouseUp: MouseFunction, handleMouseEnter: MouseFunction
        }
) => {
    let tileTyleStyle;
    if (isStart) {
